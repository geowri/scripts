...
def criar_vrt(result_folder, demList):
    ...
    # Cria o VRT usando a resolução dos rasters de entrada (resolution='highest')
...
def exportar_vrt_para_tif(vrt_path, result_folder):
    ...
    # Exporta o VRT para um arquivo TIF sem definir a resolução (usa a resolução do VRT)
    gdal.Translate(
        tif_output, vrt_path, 
